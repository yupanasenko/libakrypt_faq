...
static asn_TYPE_member_t asn_MBR_KeyProtectParameters_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct KeyProtectParameters, cipher),
...
static const asn_TYPE_tag2member_t asn_MAP_KeyProtectParameters_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_UNIVERSAL | (4 << 2)), 2, -1, 2 }, /* integritySalt */
    { (ASN_TAG_CLASS_UNIVERSAL | (4 << 2)), 5, -2, 1 }, /* encryptionIV */
    { (ASN_TAG_CLASS_UNIVERSAL | (4 << 2)), 7, -3, 0 }, /* integrityIV */
    { (ASN_TAG_CLASS_UNIVERSAL | (6 << 2)), 3, 0, 2 }, /* cipher */
    { (ASN_TAG_CLASS_UNIVERSAL | (6 << 2)), 4, -1, 1 }, /* encryptionMode */
    { (ASN_TAG_CLASS_UNIVERSAL | (6 << 2)), 6, -2, 0 } /* integrityMode */
};
