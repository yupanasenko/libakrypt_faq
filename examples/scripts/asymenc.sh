...
echo; echo "Расшифрование."
aktool d file12.bin file11.bin file10.bin file09.bin file08.bin file07.bin file06.bin file05.bin file04.bin file03.bin --inpass jQa6 --key user.key --keypass 1Qlm21u --delete-source
aktool i file
ls -la file
aktool i -c results.streebog --dont-show-stat
#
