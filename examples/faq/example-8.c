...
int main() {
    ...
    if(ak_error_ok != ak_aead_set_encrypt_key(&a, /* Контекст алгоритма аутентифицированного шифрования */
    ...
    if(ak_error_ok != ak_aead_set_auth_key(&a, /* Контекст алгоритма аутентифицированного шифрования */
    			authenticationKey, /* Область памяти, в которой хранится значение ключа 
    			аутентификации (имитозащиты) */
