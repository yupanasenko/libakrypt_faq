/* Тестовый пример, иллюстрирующий работу с контекстом алгоритма выработки имитовставки MGM.
   Тестирование процедуры шифрования данных не выполняется.
