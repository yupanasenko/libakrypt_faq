...
данной опции одовременно с созданием сертификата открытого ключа запроса на сертификат значение `string`
определяет расширенное имя владельца. 
...
на котором будет зашифрованно значение созданного ключа. С использованием опций `--password`
или `--hexpass` пароль можно определять прямо в командной строке. 
...
В первом случае будет выведена информация о параметрах созданного ключа в виде простой таблицы следующего вида
     ...
     algorithm: hmac function (hmac-streebog256, 1.2.643.7.1.1.4.1)
        number: 5b01b2178e51f79a2752c6813677afdcbfde2451be95e93c2dc846b270de73fa
         label: used for testing purpose
      resource: 65536 (key usage resource)
    not before: Thu Dec 31 13:41:20 2020
     not after: Fri Dec 31 13:41:20 2021
          file: secret-hmac256.key
