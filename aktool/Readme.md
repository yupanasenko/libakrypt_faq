...
Оция необходима в некоторых схемах выработки ключей, например,  схеме Блома.
...
содержащий большое количество тестов и примеров исопльзования утилиты aktool для выработки и верификации
