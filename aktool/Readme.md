...
*asn1*  Декодирование и печать ASN.1 данных
...
Короткая форма команды *asn1*.

## asn1 [*опции*] *файл[ы]*

Команда позволяет декодировать и вывести на печать данные,
закодированные в виде ASN.1 структуры. В настоящее время поддерживаются только der-последовательности.
Доступны следующие опции:

\--check
:   Опция заставляет утилиту провести тестирование корректности декодирования входных данных.
Тестирование производится путем повторного кодирования исходных данных и последующей проверкой на
совпадение с исходными данными.
