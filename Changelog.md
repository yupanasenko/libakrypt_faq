...
## Изменения в версии 0.7.12
 ...
 - Включена первая реализация протокола защищенного взаимодействия sp fiot.
 ...
 - Исправлен баг в функции unmask() для алгоритма Магма.
 ...
 - Добавлены функции сериализации/десериализации вычетов
   (используются для хранения точек эллиптических кривых)
