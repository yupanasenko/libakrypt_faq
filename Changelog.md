...
## Изменения в версии 0.7.14
 ...
 - Изменения в функциях внешнего интерфейса:
   * функция ak_hash_new_oid() потеряла в своем названии окончание _ni
   * реализованы функции для доступа к параметрам OID флгоритма по инлексу и по дескриптору
 - Добавлена функция внутреннего инфтерфейса ak_mac_is_iv_settable()
 - Изменено внутреннее устройство структуры, хранящей ресурс секретного ключа.
