...
## Изменения в версии 0.7.1
 - Изменено лицензирование библиотеки: техпунктовая лицензия DSB заменена на лицензию MIT.
 ...
 - Добавлен xorshift64* генератор псевдо-случайных чисел, представляющий собой
   линейный рагистр сдвига 64 бита с умножением, в качестве нелинейной функции усложнения.
