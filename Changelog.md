...
## Изменения в версии 0.8.3
 ...
 - Для блочных шифров Кузнечик и Магма реализованы:
    - режим простой замены с зацеплением согласно ГОСТ Р 34.13-2015 (с поддержкой длинных синхропосылок)
 ...
 - Деализованы и отлажены ASN.1 парсер и кодировщик в DER-формат;
 ...
 - Реализован экспорт секретных ключей
 - Добавлена функция внешнейго интерфейса ak_libakrypt_set_openssl_compability()
