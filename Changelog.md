...
## Изменения в версии 0.8.4
 ...
 - В очередной раз уточнен интерфейс функций создания секретных ключей ЭП.
 - Добавлены собственные (нестандартизированные) параметры эллиптической кривой (paramSetN0)
 - Расширен функционал утилиты aktool в части обработки ASN.1 деревьев (split, convert)
