...
## Изменения в версии 0.8.2
 ...
 - Реализована совместимость с openssl для режимов простой замены и гаммирования
  (для блочного шифра Кузнечик)
 - Возвращена и переименована в aktool консольная утилита, иллюстрирующая возможности библиотеки.
   В текущей версии обеспечивается совместимость с openssl следующих преобразований:
     streebog256, streebog512  -  md_gost12_256, md_gost12_512
