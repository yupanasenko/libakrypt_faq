...
## Изменения в версии 0.10.1
 ...
 - Многочисленные изменения фукций внешнего интерфейса
   привели к изменению номера основной версии библиотеки
...
## Изменения в версии 0.9.8
 ...
 - Утилита aktool теперь может верифицировать последовательности сертификатов,
   хранящихся в p7b контейнерах (формат cms)
