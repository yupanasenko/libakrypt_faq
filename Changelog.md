...
## Изменения в версии 0.6.6
 - Реализован механизм создания файла со значениями опций библиотеки
 - Исправлен механизм сборки документации 
  (добавлена поддержка pandoc для разборки markdown файлов)
