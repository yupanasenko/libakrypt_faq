...
## Изменения в версии 0.9.1
 ...
 - Базовая часть библиотеки и платформозависимые функции вынесены в отдельный объектный модуль
   (теперь собираются две библиотеки: 
     - libakrypt-base, библиотека с платформозависимымы и не криптографическими функциями,
     - libakrypt, библиотека с криптографическими преобразованиями )
 - Удалены функции внешнего интерфейса
 - Оставлен только один заголовочный файл libakrypt.h
 - Собираются два комплекта документации: для каждой разделяемой библиотеки отдельно
