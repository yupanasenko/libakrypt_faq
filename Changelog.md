...
## Изменения в версии 0.7.3
 ...
 - Изменены названия функций присвоения ключевых значений. Цель переименования - привести в соответсвие
 ...
 - Для класса skey введены флаги состояния контекста секретного ключа (флаг установки ключа, маски, наличия контрольной суммы)
