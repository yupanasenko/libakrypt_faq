...
## Изменения в версии 0.8.1
 ...
 - Основная причина разработки новой ветки: получить совместимость по алгоритмам шифрования
   ...
   этой ветки совместимость присутствует только для hash и hmac.
 - Изменено название собираемой библиотеки: теперь libakrypt.a и libakrypt.so
   (по-умолчанию собирается динамическая версия библиотеки)
 - Удален класс buffer
 - Изменена реализация классов hash, hmac и mac.
