...
## Изменения в версии 0.9.9
 ...
 - Уточнена реализация функций ak_bckey_cmac_clean()/_update()/_finalize()
 - Реализована структура для пошаговой реализации aead алгоритмов 
   (тестовый вариант с поддержкой некоторых aead алгоритмов:
