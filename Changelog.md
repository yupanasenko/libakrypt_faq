...
## Изменения в версии 0.9.1
 ...
 - Базовая часть библиотеки и платформозависимые функции вынесены в отдельный объектный модуль
   (собираются две библиотеки: 
     - libakrypt-base, библиотека с платформозависимымы функциями и
     - libakrypt, библиотека с криптографическими преобразованиями )
 - Удалены функции внешнего интерфейса
 - Оставлен один заголвочный файл libakrypt.h
 - Теперь собираются два комплекта документации (для каждой разделяемой библиотеки отдельно) 
