...
## Изменения в версии 0.7.9
 ...
 - Сформировано ядро - минимальный набор функций/тестовых примеров, позволяющий проводить тестирование
   процесса сборки без учета ошибок реализации криптографических механизмов
