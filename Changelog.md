...
## Изменения в версии 0.7.11
 ...
 - Отлажена реализация блочного шифра "Кузнечик" для big endian архитектуры
 - Отлажена реализация режимов ecb, ctr и omac для big endian архитектуры
 - Изменен флаг сбрки библиотеки с --std=c11 на более ранний --std=c99
   (для поддержки ранних версий gcc)
