...
if( CMAKE_HOST_UNIX )
  ...
  if( LIBAKRYPT_AKRYPT )
    ...
    install( FILES akrypt/akrypt.1 DESTINATION share/man/man1 ) # проверить, что freebsd использует тот же путь
...
# ручная деинсталляция
  ...
  if( LIBAKRYPT_AKRYPT )
    ...
    file( APPEND ${CMAKE_BINARY_DIR}/make-uninstall-${FULL_VERSION}.sh "rm -fv ${CMAKE_INSTALL_PREFIX}/share/man/man1/akrypt.1\n" )
