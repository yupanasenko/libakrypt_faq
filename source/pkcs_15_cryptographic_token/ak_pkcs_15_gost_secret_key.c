...
/*! @param p_pkcs_15_token_der указатель на токен, содержащий всю DER последовательность
    ...
    @param p_gost_key_der результат закодирования ключа
...
/*! @param p_pkcs_15_token_der указатель на токен, содержащий всю DER последовательность
    @param p_key указатель на секретный ключ
    @param p_key_attr_der результат закодирования аттрибутов ключа
    @return В случае успеха функция возввращает ak_error_ok (ноль).
    В противном случае, возвращается код ошибки.                                                   */
/* ----------------------------------------------------------------------------------------------- */
...
/*! @param p_pkcs_15_token_der указатель на токен, содержащий всю DER последовательность
    @param p_key указатель на секретный ключ
    @param p_gost_secret_key_attributes_der результат закодирования атрибутов секретного ключа ГОСТ
    @return В случае успеха функция возввращает ak_error_ok (ноль).
    В противном случае, возвращается код ошибки.                                                   */
/* ----------------------------------------------------------------------------------------------- */
...
/*! @param p_pkcs_15_token_der указатель на токен, содержащий всю DER последовательность
    @param p_key указатель на секретный ключ
    @param p_common_secret_key_attributes_der результат закодирования общих атрибутов секретного ключа
    @return В случае успеха функция возввращает ak_error_ok (ноль).
    В противном случае, возвращается код ошибки.                                                   */
/* ----------------------------------------------------------------------------------------------- */
...
/*! @param p_pkcs_15_token_der указатель на токен, содержащий всю DER последовательность
    @param p_key указатель на секретный ключ
    @param p_key_info_der результат закодирования информации о ключе
    @return В случае успеха функция возввращает ak_error_ok (ноль).
    В противном случае, возвращается код ошибки.                                                   */
/* ----------------------------------------------------------------------------------------------- */
