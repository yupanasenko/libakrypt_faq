...
int pkcs_15_put_gost_secret_key_attributes(s_der_buffer* p_pkcs_15_token_der,
        s_gost_sec_key* p_key,
...
int pkcs_15_put_common_secret_key_attributes(s_der_buffer* p_pkcs_15_token_der,
        s_gost_sec_key* p_key,
