...
int pkcs_15_generate_token(s_pkcs_15_token *p_pkcs_15_token, byte **pp_data, size_t *p_size)
{
    ...
    if(p_pkcs_15_token->m_info_size != 0)
    {
        ...
        {
            if ((error = ps_move_cursor(&pkcs_token_der, asn_get_len_byte_cnt(key_management_info_len) + 1)) != ak_error_ok)
            ...
            if ((error = ps_set(&key_management_info, pkcs_token_der.mp_curr, key_management_info_len
                                                                          +
                                                                          asn_get_len_byte_cnt(key_management_info_len) +
                             ...
                             s_der_buffer *p_pkcs_15_object_der)
{
    ...
    if((error = asn_put_universal_tlv(TSEQUENCE, NULL, objects_len, p_pkcs_15_token, p_pkcs_15_object_der)) != ak_error_ok)
        return ak_error_message(error, __func__, "problem with adding sequence tag and length");
...
int pkcs_15_put_obj(s_der_buffer *p_pkcs_15_token, s_pkcs_15_object *p_pkcs_15_object, s_der_buffer *p_added_pkcs_15_object_der)
{
    ...
    if ((error = ps_set(p_added_pkcs_15_object_der, p_pkcs_15_token->mp_curr, direct_object_len + asn_get_len_byte_cnt(direct_object_len) + 1, PS_U_MODE)) != ak_error_ok)
        return ak_error_message(error, __func__, "problems with making union of asn data");
...
int pkcs_15_put_obj_direct(s_der_buffer *p_pkcs_15_token, s_pkcs_15_object *p_pkcs_15_object, s_der_buffer *p_direct_pkcs_15_object_der)
{
    ...
    {
        case SEC_KEY:
            if ((error = pkcs_15_put_gost_key(p_pkcs_15_token, p_pkcs_15_object->m_obj.mp_sec_key, &gost_key)) != ak_error_ok)
                                    ...
                                    s_der_buffer *p_key_management_info_der)
{
    ...
    {
        case PWD_INFO:
            if ((error = pkcs_15_put_password_info(p_pkcs_15_token, p_key_management_info->m_key_info.mp_pwd_info, &key_info)) != ak_error_ok)
    ...
    if((error = asn_put_universal_tlv(TOCTET_STRING, (void*)&p_key_management_info->m_key_id, 0, p_pkcs_15_token, &key_id)) != ak_error_ok)
    ...
    if((error = asn_put_universal_tlv(TSEQUENCE, NULL, key_management_info_len, p_pkcs_15_token, p_key_management_info_der)) != ak_error_ok)
        return ak_error_message(error, __func__, "problem with adding sequence tag and length");
...
int pkcs_15_put_password_info(s_der_buffer *p_pkcs_15_token, s_pwd_info *p_pwd_info, s_der_buffer *p_pwd_info_der)
{
    ...
    {
        if((error = asn_put_universal_tlv(TUTF8_STRING, (void*)&p_pwd_info->m_hint, 0, p_pkcs_15_token, &hint)) != ak_error_ok)
    ...
    if ((error =  ps_set(p_pwd_info_der, p_pkcs_15_token->mp_curr, password_info_len + asn_get_len_byte_cnt(password_info_len) + 1, PS_U_MODE)) != ak_error_ok)
        return ak_error_message(error, __func__, "problems with making union of asn data");
...
int pkcs_15_put_alg_id(s_der_buffer *p_pkcs_15_token, s_pwd_info *p_pwd_info, s_der_buffer *p_alg_id_der)
{
    ...
    if((error = asn_put_universal_tlv(TOBJECT_IDENTIFIER, (void*)&p_pwd_info->m_algorithm, 0, p_pkcs_15_token, &algorithm)) != ak_error_ok)
...
int pkcs_15_put_params_pbkdf2(s_der_buffer *p_pkcs_15_token, s_pwd_info *p_pwd_info, s_der_buffer *p_parameters_der)
{
    ...
    {
        s_der_buffer algorithm = {0};
        if((error = asn_put_universal_tlv(TOBJECT_IDENTIFIER, (void*)&p_pwd_info->m_prf_id, 0, p_pkcs_15_token, &algorithm)) != ak_error_ok)
            return ak_error_message(error, __func__, "problem with adding algorithm oid");
    ...
    {
        if((error = asn_put_universal_tlv(TINTEGER, (void*)&p_pwd_info->m_key_len, 0, p_pkcs_15_token, &key_length)) != ak_error_ok)
            return ak_error_message(error, __func__, "problem with adding key length");
    }

    s_der_buffer iteration_count = {0};
    if((error = asn_put_universal_tlv(TINTEGER, (void*)&p_pwd_info->m_iteration_count, 0, p_pkcs_15_token, &iteration_count)) != ak_error_ok)
     ...
     */
    s_der_buffer salt = {0};
    if((error = asn_put_universal_tlv(TOCTET_STRING, (void*)&p_pwd_info->m_salt, 0, p_pkcs_15_token, &salt)) != ak_error_ok)
    ...
    if((error = asn_put_universal_tlv(TSEQUENCE, NULL, parameters_len, p_pkcs_15_token, p_parameters_der)) != ak_error_ok)
        return ak_error_message(error, __func__, "problem with adding sequence tag and length");
...
int pkcs_15_get_password_info(s_der_buffer *p_sngl_kmi_der, s_pwd_info *p_pwd_info)
{
    ...
    if((error = asn_get_expected_tlv((CONTEXT_SPECIFIC | CONSTRUCTED | PWD_INFO), p_sngl_kmi_der, (void *) &pwd_info)) != ak_error_ok)
        return ak_error_message(error, __func__, "problems with getting single key management info in der");
...
int pkcs_15_get_params_pbkdf2(s_der_buffer *p_alg_id_der, s_pwd_info *p_pwd_info)
{
    ...
    if((error = asn_get_expected_tlv((TINTEGER), &pbkdf2_prms, (void *) &p_pwd_info->m_iteration_count)) != ak_error_ok)
...
int pkcs_15_get_pkcs_objects(s_der_buffer *p_pkcs_15_token_der, s_pkcs_15_token *p_pkcs_15_token)
{
    ...
    if((error = asn_get_expected_tlv((CONSTRUCTED | TSEQUENCE), p_pkcs_15_token_der, (void *) &pkcs_15_objects)) != ak_error_ok)
...
void print_ps(s_ptr_server* p_ps)
{
    if(p_ps)
    {
        for(size_t i = 0; i < ps_get_curr_size(p_ps); i++)
            printf("%02X ", p_ps->mp_curr[i]);
        printf("\n");
    }
}
...
void free_pkcs_15_object(s_pkcs_15_object* p_object)
{
    if(p_object)
    {
        ...
        {
            case SEC_KEY: pcks_15_free_gost_sec_key(p_object->m_obj.mp_sec_key); break;
            case PRI_KEY: break;
            case PUB_KEY: break;
            default: break;
        }
