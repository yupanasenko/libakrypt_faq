...
/* ----------------------------------------------------------------------------------------------- */
/*! \brief Инициализация секретного ключа алгоритма выработки имитовставки HMAC-Стрибог256. */
 int ak_hmac_key_create_streebog256( ak_hmac_key, const ak_pointer , const size_t );
