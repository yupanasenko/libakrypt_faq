...
/*! \brief Перечисление, определяющее флаги хранения и обработки секретных ключей. */
 typedef enum {
  ...
  /*! \brief Второй бит отвечает за установку контрольной суммы ключа:
   ...
   skey_flag_set_icode      = 0x00000004LL,
