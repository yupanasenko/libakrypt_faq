...
/*
 в блоках по 8 байт
            (может принимать значения  \ref ak_mpzn256_size или \ref ak_mpzn512_size. Последний параметр содержит
            кофактор порядка группы точек эллиптической кривой

*/

 struct wcurve_static
{
 /*! \brief 8-ми байтная область памяти, содержащая размер параметров эллиптической кривой. */
  ak_uint32 size[2];
 /*! \brief Коэффициент \f$ a \f$ эллиптической кривой. */
 ...
 /*! \brief Значение величины \f$ r^2\f$, взятое по модулю \f$ p \f$ и используемое в арифметике Монтгомери. */
