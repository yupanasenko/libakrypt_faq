...
/*! В качестве алгоритма выработки имитовставки может выступать
     - алгоритм hmac на основе любой реализованной функции хеширования,
     - алгоритм, регламентируемый ГОСТ Р 34.13-2015, с использованием любого реализованного блочного шифра,
     - алгоритм электронной подписи, регламентируемый ГОСТ Р 34.12-2012, с использованием любого
       реализованного набора параметров эллиптической кривой. */
/* ----------------------------------------------------------------------------------------------- */
 typedef enum {
...
/*! \brief Ключ алгоритма выработки имитовставки. */
 typedef struct mac {
  ...
  /*! \brief контекст алгоритма */
   union {
     struct hmac _hmac; /*!< алгоритм hmac */
     struct bckey _bckey; /*!< электронная подпись */
     struct signkey _signkey; /*!< алгоритм на основе блочного шифра */
   } choice;
