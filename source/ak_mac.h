...
/*! \brief Структура предназначенная для итеративного вычисления значений сжимающих отображений.
    ...
    так и функции выработки имитовставки (ключевые функции хеширования).
    Текущая реализаия поддерживает следующие алгоритмы:
    - функции хеширования Стрибог-256 и Стрибог-512,
    - функцию ключевого хеширования HMAC на основе функций хеширования семейства Стрибог,
    - алгоритм выработки имитовставки OMAC1, регламентируемый ГОСТ Р 34.13-2015,
    - алгоритм выработки имитовставки MGM.                                                         */
/* ----------------------------------------------------------------------------------------------- */
 typedef struct mac
{
...
/* ----------------------------------------------------------------------------------------------- */
/*! \brief Обновление одного контекста сжимающего отображения ключевым значением,
    содержащимся во втором контексте. */
 int ak_mac_context_update_mac_context_key( ak_mac, ak_mac );
