...
/*! \brief Создание нового элемента структуры управления контекстами. */
 ak_context_node ak_context_node_new( const ak_pointer , const ak_handle , ak_oid , char * );
...
/*! \brief Добавление контекста в структуру управления контекстами. */
 ak_handle ak_context_manager_add_node( ak_context_manager , const ak_pointer , ak_oid , char * );
...
/*! \brief Помещение созданного объекта в глобальную структуру управления контекстами. */
 ak_handle ak_libakrypt_add_context( ak_pointer , ak_oid , char * );
