...
/* ----------------------------------------------------------------------------------------------- */
/*! \brief Создание дескриптора функции хэширования ГОСТ Р 34.11-94 с заданными таблицами замен. */
 dll_export ak_handle ak_hash_new_gosthash94( ak_handle );
/*! \brief Создание дескриптора функции хэширования ГОСТ Р 34.11-94 с таблицами замен из CSP. */
 dll_export ak_handle ak_hash_new_gosthash94_csp( void );

/*! \brief Получение длины хэшкода для заданной функции хэширования (в байтах). */
 dll_export size_t ak_hash_get_code_size( ak_handle );
/*! \brief Получение длины блока обрабатываемых заданной функцией хэширования данных (в байтах). */
