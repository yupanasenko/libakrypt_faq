...
/* ----------------------------------------------------------------------------------------------- */
 ...
 /*! \brief ASN.1 дерево, содержащее в себе расширенное имя владельца ключа (согласно ITU-T X.509) */
  ak_tlv name;
 /*! \brief флаги ключа */
  ak_uint64 flags;
} *ak_verifykey;
...
/*! \brief Функция добавляет к расширенному имени владельца ключа новую строку. */
 int ak_verify_context_set_name_string( ak_verifykey , const char * , const char * );
