...
/* ----------------------------------------------------------------------------------------------- */
/*! Функция пытается считать данные из файла в буффер, на котороый указывает `ptr`.
    ...
    \param ptr указатель на массив, в который будут считаны данные;
 ...
 ak_uint8 *ak_ptr_load_from_file( ak_pointer buf, size_t *size, const char *filename )
{
 ...
 /* сохраняем размер выделенных данных */
