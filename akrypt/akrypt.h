...
/* ----------------------------------------------------------------------------------------------- */
 ...
 extern ak_function_log *logfunc;
...
/* ----------------------------------------------------------------------------------------------- */
/* функция для реализации команды OID - действий с идентификаторами криптографических механизмов */
 int oid( int argc, char *argv[] );
/* вывод информации об OID */
 void show_oid( ak_handle handle );
/* вывод справки по команде oid */
