...
Поскольку некоторые алгоритмы накладывают ограничения на использование ключа,
...
то используйте следующие алгоритмы: *hmac-streebog256* и *mac-streebog512*.
...
алгоритма "Стребоог256" и помещает результат вычислений в файл result.streebog.
