...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Вычисление 32-битной контрольной суммы возможно с помощью функции ``ak_ptr_fletcher32``, которая вычисляет КС по алгоритму Флетчера, или с помощью ``ak_ptr_fletcher32_xor``, работающей по модифицированному алгоритму Флетчера, заменяющего обычное модульное сложение на операцию поразрядного сложения по модулю 2.
