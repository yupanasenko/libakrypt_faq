...
`akrypt`, предназначенной для проведения криптографических преобразований с файлами,
в частности, утиита предоставляет возможность вычислять контрольные суммы файлов, зашифровывать их и подписывать
...
менять значения технических и критографических характеристик библиотеки.
...
содержит только базовые преобразования:
 ...
 - реализацию операций сложения и удвоения, а также вычисления кратной точки на эллиптических кривых,
