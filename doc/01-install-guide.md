...
* если у Вас установлена программа qhelpgeneraator (входит в стандартную установку библиотеки Qt),
...
1. Файл `libakrypt-doc-0.x.pdf`, содержащий документацию в формате PDF (файл формируется с помощью системы подготовки
   документации LaTeX),
2. Файл `libakrypt-doc-0.x.qch`, содержащий документацию в формате QCH (удобно интегрируется в среду разработки QtCreator),
3. Архив `libakrypt-doc-0.x.tar.bz2`, содержащий в архивированном виде
